...
func TestRequiredFiles(t *testing.T) {
	required := []string{
		...
		".agents/skills/open-agent-session/SKILL.md",
		".agents/skills/record-work/SKILL.md",
	}
...
func TestSkillFrontmatter(t *testing.T) {
	skills := []string{"plan-work", "implement-task", "review-change", "open-agent-session", "record-work"}
