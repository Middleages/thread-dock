...
- 후속 변경분 최종 독립 통합 리뷰 `d6aff6bd0a50618b86d82ea4a05320d191b6ecbb`는 ACCEPT/blockers0이다. 이후 변경은 승인·게시 문서뿐이며 코드 gate를 반복하지 않는다. PR92 본문과 [Issue91 결과 댓글](https://github.com/Middleages/thread-dock/issues/91#issuecomment-5657092292)에 새111tests/Windows 결과를 반영했다.
